...
<body>
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item" href="physch.php">Baby-sitter</a>
    ...
    <!--Background section-->
    <div style="background-image: linear-gradient(to left,rgba(0,0,0,0.8),rgba(0,0,0,0)),url('./img/bacimg.jpg');
        background-size: cover; 
        height:380px; padding-top: 150px; text-align: center;">

        <h1 style="font-size:55px; color:rgb(255, 255, 255); margin:10px; text-shadow: 2px 2px 8px #000000;">Physchologist</h1>
    </div>
    <!--Background section-->
    ...
    <div class="container mt-4 d-flex justify-content-center p-5">
        <div class="row">
            ...
            <div class="col-md-4 P-2">
                <div class="cards">
                    <div class=" third bg-white p-4 text-center"> <img src="./img/DM.jpg" class="img-fluid" align="center" style="height: auto;" />
                        <h4 class="text-center m-2"> Madhav</h4> <br/>
                        <p class="text-center m-2">Physchologist</p> <br/>
            ...
            <div class="col-md-4 P-2">
                <div class="cards">
                    <div class=" third bg-white p-4 text-center"> <img src="./img/DF.jpg" class="img-fluid" align="center" style="height: auto;" />
                        <h4 class="text-center m-2">madhavi</h4> <br/>
                        <p class="text-center m-2">Physchologist</p> <br/>
                        <table class="table table-hover">
                            <tr>
                                <td><b>Speciality:</b></td>
            ...
            <div class="col-md-4 P-2">
                <div class="cards">
                    <div class=" third bg-white p-4 text-center"> <img src="./img/DM.jpg" class="img-fluid" align="center" style="height: auto;" />
                        <h4 class="text-center m-2">Mohith</h4> <br/>
                        <p class="text-center m-2">Baby-sitter</p> <br/>
                        <table class="table table-hover">
                            <tr>
                                <td><b>Speciality:</b></td>
                                <td>Good Listener</td>
