...
<body>
    ...
    <!--Background section-->
    <div style="background-image: linear-gradient(to left,rgba(0,0,0,0.8),rgba(0,0,0,0)),url('./img/Neanogonist.jpg');
        background-size: cover; 
        height:380px; padding-top: 150px; text-align: center;">

        <h1 style="font-size:55px; color:rgb(255, 255, 255); margin:10px; text-shadow: 2px 2px 8px #000000;">Childcare</h1>
    </div>
    <!--Background section-->
        ...
        <div class="row">
            ...
            <div class="col-md-4 P-2">
                <?php 
                 ...
                 $sql="select cname,ctype,cspecial,cplace,cavail,cgender,cadress,cphone from child ";
    ...
    ?>
                ...
                <div class="cards">
                    <div class="first bg-white p-4 text-center">
                        <img src="./img/DM.jpg " class="img-fluid " align="center " style="height: auto; ">
                        <h4 class="text-center m-2"><php echo $row['cname']></h4> <br/>
                        <?php
                        }
                    }
                    ?>
                        <p class="text-center m-2">Child-care</p> <br/>
            ...
            <div class="col-md-4 P-2">
                <div class="cards">
                    <div class="first bg-white p-4 text-center">
                        <img src="./img/man3.jpg " class="img-fluid " align="center " style="height: auto; ">
                        <h4 class="text-center m-2"> Bhavna</h4> <br/>
                        <p class="text-center m-2">Child-care</p> <br/>
                        <table class="table table-hover">
                            <tr>
                                <td><b>Speciality:</b></td>
            ...
            <div class="col-md-4 P-2">
                <div class="cards">
                    <div class="first bg-white p-4 text-center">
                        <img src="./img/DM.jpg " class="img-fluid " align="center " style="height: auto; ">
                        <h4 class="text-center m-2">Rohan</h4> <br/>
                        <p class="text-center m-2">Child-care</p> <br/>
                        <table class="table table-hover">
                            <tr>
                                <td><b>Speciality:</b></td>
